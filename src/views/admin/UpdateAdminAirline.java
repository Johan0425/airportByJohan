 ...
 * @author joanp
 */
public class UpdateAdminAirline extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form UpdatedAdminAirline
     *
     * @param admin
     * @param view
     * @param airlineView
    ...
    public UpdateAdminAirline(Employee admin, AdminsAirline view, Airlines airlineView, Airline airline, AdminTasks view2) {
        ...
        setTitle("Actualización de datos - " + admin.getFullname());
        setResizable(false);
        setSize(1200, 700);
    ...
    private void validateFields() {
        ...
        if (!adminId.isEmpty() && !adminId.equals(admin.getId()) && employee != null) {
            idAdminWarning.setVisible(true);
            enableBtnUpdateAdmin = false;
        } else if (!adminUsername.isEmpty() && !adminUsername.equals(admin.getUsername()) && usernameInUse) {
    ...
    private void showAdminData() {
        txtAdminId.setText(admin.getId());
        txtAdminName.setText(admin.getFullname());
        txtAdminEmail.setText(admin.getEmail());
        txtAdminUsername.setText(admin.getUsername());
        txtAdminPassword.setText(admin.getPassword());
        txtAdminSalary.setText(String.valueOf(admin.getSalary()));
    ...
    private void btnUpdateAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateAdminActionPerformed
        ...
        Employee updatedAdmin = new Employee(emailAdmin, salaryAdmin, age, Role.AIRLINE_ADMIN, adminId, adminName, usernameAdmin, passwordAdmin);
